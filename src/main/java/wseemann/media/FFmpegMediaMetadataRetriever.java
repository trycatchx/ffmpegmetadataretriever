...
public class FFmpegMediaMetadataRetriever {
    ...
    // The field below is accessed by native methods.保存JNI层里面调用ffmpeg 的接口对象的地址。
    // 每一个FFmpegMediaMetadataRetriever类都有不同 的mNativeContext值，解决多线程问题
     ...
     */
    public native void __setDataSource(FileDescriptor fd, long offset, long length)
            throws IllegalArgumentException;
     ...
     *
     * @param One of the constants listed below at the end of the class.
     ...
     */
    private native final HashMap<String, String> nativeGetMetadata(boolean update_only,
